...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{MSFR1.png}
...
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{MMETZ.png}
        \caption{Relación sin tener en cuenta el efecto del polvo}
        \label{fig:met11}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{MMETDUSTZ.png}
...
\begin{DispWithArrows}[format=c, displaystyle, subequations]
 M_{G}=e^{\mathrm{Z_{G}}+2.1398616} +\log_{10}(z) \\
 \log_{10}(M_G)=\sqrt{\mathrm{Z_{G}^{dust}+0.82549924}}+ 0.11256291\log_{10}(z)
\end{DispWithArrows}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{SFRAVM.png}
